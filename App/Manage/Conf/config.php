...
return array(
	...
	'RBAC_ROLE_TABLE' => 'xyh_role',		//数据库角色表名称
	'RBAC_USER_TABLE' => 'xyh_role_user',//角色与用户的中间表名,不是用户表名
	'RBAC_ACCESS_TABLE' => 'xyh_access',	//权限表名
	'RBAC_NODE_TABLE'	=> 'xyh_node',	//节点表名称
	...
	'TMPL_PARSE_STRING' => array(
		'__PUBLIC__' =>  ltrim(APP_PATH,'.'). MODULE_NAME . '/View/Public',
		'__DATA__' => '/Data',
	),
);
